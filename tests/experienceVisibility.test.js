...
assert.ok(html.includes('data-download-en="assets/downloads/K.Romsicki_cv_EN_1.pdf"'), "PHP render should expose the English CV path");
assert.ok(html.includes('data-print-de="assets/downloads/K.Romsicki_cv_EN_1.pdf"'), "PHP render should use the English CV as German fallback");
